...
export function AppHeader({ breadcrumbs = [] }: Props) {
    ...
    const baseUrl = auth.user?.avatar_url ?? auth.user?.avatar ?? undefined;
                ...
                <div className="border-b border-amber-500/30 bg-amber-500/10">
                    <div className="mx-auto flex items-center justify-between gap-2 px-4 py-2 text-amber-900 md:max-w-7xl dark:text-amber-300">
                        <div className="text-sm">
                            You are impersonating {auth.user?.name}. Actions are
                            recorded.
                        </div>
                        <Button
                            size="sm"
                            ...
                            onClick={() => {
                                window.location.href =
                                    '/admin/users/stop-impersonating';
                            }}
