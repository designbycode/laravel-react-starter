...
function SidebarProvider({
  ...
  // Read/write state from our centralized store instead of cookies
  const storedOpen = useSidebarStore((s) => s.isOpen)
  const setStoredOpen = useSidebarStore((s) => s.setOpen)
